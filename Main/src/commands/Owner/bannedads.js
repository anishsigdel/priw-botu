...
module.exports = {
  ...
  description: 'Reklam engelleme sistemini <aç/kapat>.',
  category: 'Owner',
  async execute(message, args) {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        .setDescription(`Reklam engelleme sistemi **${status}** hale getirildi. Ayarın tam-mod aktif hale getirilmesi için lütfen aşağıdaki menüden **Yeniden Başat'ı** seçiniz!`);
