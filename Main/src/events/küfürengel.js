...
module.exports = {
  ...
  async execute(message) {
    ...
    if (filter && filter.isActive) {
      ...
      const küfürMap = ["realoxyoc","realoxyoç","realoxyamk","realoxyaq","0r0spuc0cu","4n4n1 sk3r1m","p1c","@n@nı skrm","evladi","orsb","orsbcogu","amnskm","anaskm","oc",
        "a\u011fz\u0131na s\u0131\u00e7ay\u0131m","seks","sex","realoxys\u0131z","amar\u0131m","ambiti","am biti","amc\u0131\u011f\u0131","amc\u0131\u011f\u0131n",
      ...
      for (const küfür of küfürMap) {
        if (mesaj.includes(küfür)) {
          ...
          const replyMessage = await message.channel.send({
            content: `${emojis.pikachu} Merhaba ${message.author} Bu sunucuda küfür engel açık. Lütfen küfür kullanımından kaçının! ${emojis.basvuru}`
          });
